...
This is a sample standard operating protocol for staff using Microsoft Visio for process mapping and information visualisation within their health, social care, or housing teams. The document is not exhaustive and additional information can be found in the the appendix.
...
![If using the suggested arrows to generate shapes and connectors, hover over the arrows, choose the desired shape, and a new shape will be created connected via arrow to the original shape.](images/clipboard-1837299990.png){height="300px" #figz-arrn}

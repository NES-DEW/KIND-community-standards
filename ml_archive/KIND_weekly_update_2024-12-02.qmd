...
scodas <- dplyr::tibble(Date = c("2024-12-03"),
  Topic = c("Predictors of DNAs for OP Paediatrics"),
  Presenter = c("Nora Villamil Buenrostro"),
  `Contact Details` = c("nora.villamilbuenrostro@nhs.scot"))
...
Welcome to our regular KIND network update. We'll have a firm schedule for the KIND unconference out early next week, so do please save the date (9.30-16.30, Wednesday 11th December) if you haven't already. Last call too for Q1 2025 [training requests](https://forms.office.com/e/zLaKHXvcBt).
...
## Wins of The Week
In the spirit of [#IAmRemarkable](https://www.rmrkblty.org/iamremarkable), we do a weekly wins of the week thread to celebrate the professional (and personal) achievements of the community. A power-of-presenting special this week:

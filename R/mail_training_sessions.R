...
mail_training_sessions <- function(tr_type = "all", start_date = "today", end_date = lubridate::dmy("01-12-2025")){
  
  sesh <- readr::read_csv("https://raw.githubusercontent.com/NES-DEW/KIND-training/main/data/KIND_training_sessions.csv")
  
  schedule <- readr::read_csv("https://raw.githubusercontent.com/NES-DEW/KIND-training/main/data/training_schedule.csv")

...
## What doesn't the KIND network do?

The KIND network isn't a consultancy or a bureau: we don't undertake analytical work for organisations, and we ask that members refrain from soliciting paid or free work via the network. That means that we expressly forbid posts on the Teams channel that contain any of the following:

+ requests for help that fall outwith the scope of learning or development
+ any requests for the provision of expertise that might conceivably replace properly-procured services in your organisation
+ requests to support the administration of services
+ requests for analytical work to be completed by network members
+ any other kind of service provision to you or your organisation

We reserve the right to remove any post where the focus is not clearly on learning and development. Please contact [Brendan Clarke](mailto:brendan.clarke2@nhs.scot) with any queries.

## Who runs/owns/funds the KIND network?

The KIND Learning Network is based at [Public Services Delivery Scotland](https://publicservicesdelivery.scot/) (PSD Scotland), as part of the Digitally Enabled Workforce programme. That’s a programme that builds foundational resources to support digital skills and leadership at all levels. You might have heard about our Professional Development Award in Technology Enabled Care programme, used the M365 Skills Hub, or been involved with the Digital Leadership Programme. This work is all funded through Scottish Government via the Digital Health and Care Portfolio Board.
...
Training is open to all across Scotland's health, social care, and housing sector. All sessions are free, and (with two provisos) open to all. Those provisos are:

1. We offer training across a range of tools, and at a range of levels. While sessions are open to all, not all sessions will be suitable for your needs and interests, and may require software or other infrastructure to which you do not have access. It is your responsibility to check carefully the requirements and prerequisites of a training session before registering.
1. All our training is intended for personal development. We only want people to attend who want to develop their skills. As a result, please note that our sessions are not open to colleagues who are being compelled to attend. Please only come to our training if you personally want to attend.
